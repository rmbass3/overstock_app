      ...
      <ScrollAnimation className="contact-containter-animation" animateIn="fadeIn" duration={2}>
        <div className="contact-container">
          <div className="contact-map-container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3231.083860961134!2d-80.0380776!3d35.9204473!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88530b81c8f99bed%3A0x2d169abe421fbfec!2sOverstock%20Discount%20Flooring!5e0!3m2!1sen!2sus!4v1671396790324!5m2!1sen!2sus" title="contact-map" className="contact-map"/>
          </div>
          <div className="contact-info-container">
            <div className="contact-left">
              ...
              <div className="contact-flex-container">
                ...
                <h4 className="contact-info">
                  ...
                  <a target="_blank" rel="noreferrer" href="https://goo.gl/maps/FhjPGcsgPBfLev4X9">
                    908 Old Thomasville Rd <br/>
                    High Point, NC
                    27260
                  </a>
                </h4>
            ...
            <div className="contact-right">
              ...
              <div className="hours-flex-container">
                ...
                <h4 className="contact-hours">Sat: 8AM-12PM</h4>
